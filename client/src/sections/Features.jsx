    ...
    >
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-3xl text-gray-300 mb-24">
          Take control of your time with Chalkboard's powerful tools:
        </p>

        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-20 gap-y-10 text-left text-gray-300 text-2xl max-w-4xl mx-auto">
          <li className="flex items-start gap-5">
            ✅ <span>AI-generated study schedules</span>
          </li>
          <li className="flex items-start gap-5">
            ✅ <span>Easy upload of course outlines</span>
          </li>
          <li className="flex items-start gap-5">
            ✅ <span>Reminders and tracking</span>
          </li>
          <li className="flex items-start gap-5">
            ✅ <span>Beautiful, intuitive calendar</span>
          </li>
        </ul>
      </div>
    </motion.section>
