...
const Filter = ({ onFinish }) => {
  ...
  // Add Canadian semester options
  const semesterOptions = [
    { label: 'Fall 2023', start: '2023-09-05', end: '2023-12-20' },
    { label: 'Winter 2024', start: '2024-01-08', end: '2024-04-26' },
    { label: 'Summer 2024', start: '2024-05-06', end: '2024-08-16' },
    { label: 'Fall 2024', start: '2024-09-03', end: '2024-12-20' },
    { label: 'Winter 2025', start: '2025-01-06', end: '2025-04-25' },
    { label: 'Summer 2025', start: '2025-05-05', end: '2025-08-15' },
  ];
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-white rounded-lg shadow">
      ...
      {/* Only show semester dropdown at the top */}
      <div className="space-y-4 mb-6">
        <div>
          <label className="text-sm block mb-1">Select Semester</label>
          <select
            className="w-full border px-3 py-2 rounded"
            value={newCourse.semester || ''}
            onChange={e => {
              const selected = semesterOptions.find(opt => opt.label === e.target.value);
              if (selected) {
                setNewCourse({
                  ...newCourse,
                  semester: selected.label,
                  startDate: selected.start, // used in backend only
                  endDate: selected.end,
                });
              } else {
                setNewCourse({ ...newCourse, semester: '', startDate: '', endDate: '' });
              }
            }}
          >
      ...
      {((manualMode && showCourseForm) || (!manualMode && uploaded)) && (
